...
public class AuthenticationController {
  ...
  ApiResponse<AuthenticationRestponse> authenticateJwt(@RequestBody AuthenticationRequest request) {
    ApiResponse<AuthenticationRestponse> apiResponse = new ApiResponse<>();
  ...
  /* ------------------------------------------------------------------------------- */
  @PostMapping("/logout")
  ApiResponse<String> logoutJwt(@RequestBody LogoutRequest request)
  ...
  /* ------------------------------------------------------------------------------- */
  @PostMapping("/refresh")
  ApiResponse<AuthenticationRestponse> refreshToken(@RequestBody RefreshRequest request)
      throws JOSEException, ParseException {
    ApiResponse<AuthenticationRestponse> apiResponse = new ApiResponse<>();
    AuthenticationRestponse result = authenticationService.refreshToken(request);
    apiResponse.setResult(result);
    return apiResponse;
  }
  ...
  ApiResponse<IntrospectRestponse> validate(@RequestBody IntrospectRequest request)
      throws JOSEException, ParseException {
    var result = authenticationService.validate(request);

    ApiResponse<IntrospectRestponse> apiResponse = new ApiResponse<>();
    apiResponse.setResult(result);
    return apiResponse;
  }
  ...
  ApiResponse<IntrospectRestponse> validate2(@RequestBody IntrospectRequest request)
      throws JOSEException, ParseException {
